...
**Ansible filter**
  - Custom filter netaddr_iter_iprange [254](https://github.com/vbotka/ansible-examples/tree/master/examples/example-254),
  - Issue to_yaml|from_yaml [267](https://github.com/vbotka/ansible-examples/tree/master/examples/example-267),
  - MAC address filter [197](https://github.com/vbotka/ansible-examples/tree/master/examples/example-197),
...
**Basics**
  ...
  - role [178](https://github.com/vbotka/ansible-examples/tree/master/examples/example-178),
...
**Cache**
  ...
  - jsonfile [181](https://github.com/vbotka/ansible-examples/tree/master/examples/example-181),
...
**Devel**
  ...
  - Job management [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
  - Supports_check_mode and changed [279](https://github.com/vbotka/ansible-examples/tree/master/examples/example-279),
  - async [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
  - async_status [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
  - cache [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
  - filter_core [291](https://github.com/vbotka/ansible-examples/tree/master/examples/example-291),
  - kill [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
  - logger [287](https://github.com/vbotka/ansible-examples/tree/master/examples/example-287),
...
**Python method**
  ...
  - split [251](https://github.com/vbotka/ansible-examples/tree/master/examples/example-251),
...
**Utility**
  ...
  - ansible-playbook [213](https://github.com/vbotka/ansible-examples/tree/master/examples/example-213),
  ...
  - ansible_check_mode [213](https://github.com/vbotka/ansible-examples/tree/master/examples/example-213),
  - jq [60](https://github.com/vbotka/ansible-examples/tree/master/examples/example-060),
  - parameter --check [213](https://github.com/vbotka/ansible-examples/tree/master/examples/example-213),
...
**Vars**
  ...
  - pause [36](https://github.com/vbotka/ansible-examples/tree/master/examples/example-036),
  - vars_prompt [36](https://github.com/vbotka/ansible-examples/tree/master/examples/example-036),
...
- [Example  21.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-021) Ansible function; split;
...
- [Example 140.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-140) Ansible function; json_query functions;
...
- [Example 178.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-178) Basics; role; vars;
...
- [Example 181.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-181) Cache; jsonfile; cache plugin;
...
- [Example 213.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-213) Utility; ansible-playbook; parameter --check; ansible_check_mode;
...
- [Example 254.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-254) Ansible filter; ipaddr; ansible.netcommon.ipaddr; Custom filter netaddr_iter_iprange;
...
- [Example 267.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-267) Ansible filter; json_query; Issue to_yaml|from_yaml;
...
- [Example 289.](https://github.com/vbotka/ansible-examples/tree/master/examples/example-289) Ansible function; ansible.utils.keep_keys; ansible.utils.remove_keys; ansible.utils.replace_keys;
